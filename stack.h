...
extern error_t stack_push_multi(const uint32_t *words, mem_size bytes);

extern error_t stack_pop(uint32_t *word);
extern error_t stack_pop_multi(uint32_t *words, mem_size bytes);

extern error_t stack_skip(mem_size bytes);
extern error_t stack_unskip(mem_size bytes);
